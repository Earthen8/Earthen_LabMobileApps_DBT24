...
class HazardousWasteEducationScreen extends StatelessWidget {
  const HazardousWasteEducationScreen({super.key});
          ...
          children: [
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: const DecorationImage(
                    image: NetworkImage("https://placehold.co/350x230"),
                    fit: BoxFit.cover,
                  ),
                ),
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const Text(
                        'Hazardous waste includes toxic, flammable, or corrosive materials like chemicals and batteries, posing risks to health and the environment. Proper handling prevents pollution and disasters!',
                        textAlign: TextAlign.center,
                        style: TextStyle(
                          color: Colors.white,
                          fontSize: 13,
            ...
            Padding(
              ...
              child: Wrap(
                ...
                children: const [
                  _ImpactItem(
                    title: 'Soil Sterility',
                    icon: Icons.grass, // Approximate icon
                  ),
                  _ImpactItem(title: 'Air Poisoning', icon: Icons.air),
                  _ImpactItem(title: 'Water Mutation', icon: Icons.water_drop),
                  _ImpactItem(title: 'Ecosystem Collapse', icon: Icons.forest),
                  _ImpactItem(
                    title: 'Fire Hazards',
                    icon: Icons.local_fire_department,
                  ),
                  _ImpactItem(title: 'Chemical Rain', icon: Icons.cloud),
                ],
              ),
            ),
            ...
            const Padding(
              padding: EdgeInsets.symmetric(horizontal: 40),
              child: Text(
                'Myth and Facts About Hazardous Waste',
                textAlign: TextAlign.center,
                style: TextStyle(
                  color: Colors.black,
                  fontSize: 20,
              ...
              child: Row(
                children: const [
                  _MythFactCard(
                    ...
                    content: "Household waste is never hazardous",
                  ...
                  _MythFactCard(
                    ...
                    content:
                        "Many everyday items like cleaners and paints contain toxic chemicals",
            ...
            const Padding(
              padding: EdgeInsets.symmetric(horizontal: 40),
              child: Text(
                'Why Managing Hazardous Waste Matters',
                textAlign: TextAlign.center,
                style: TextStyle(
                  color: Colors.black,
                  fontSize: 20,
...
class _StackedWhyMatterCardsState extends State<_StackedWhyMatterCards>
  ...
  final List<Map<String, String>> _cards = [
    ...
    },
    {
      ...
      'description':
          'Toxic waste in soil doesn’t just make land infertile, it can also alter plant DNA, leading to weaker, nutrient-deficient crops',
    },
  ];
...
class _AnimatedWasteCarouselState extends State<_AnimatedWasteCarousel> {
  ...
  final List<Map<String, String>> _items = [
    {'label': 'Chemical Solvents', 'image': 'https://placehold.co/200x250'},
    {'label': 'Industrial Sludge', 'image': 'https://placehold.co/144x180'},
    {'label': 'Pesticides', 'image': 'https://placehold.co/144x180'},
  ];
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              ...
              style: const TextStyle(
                color: Colors
                    .white, // Ensure text is white for contrast against dark gradient
                fontSize: 14,
                fontFamily: 'Poppins',
                fontWeight: FontWeight.w400,
              ),
