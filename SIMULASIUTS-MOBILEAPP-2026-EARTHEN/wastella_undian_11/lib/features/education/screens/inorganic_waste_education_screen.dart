...
class InorganicWasteEducationScreen extends StatefulWidget {
  const InorganicWasteEducationScreen({super.key});

  @override
  State<InorganicWasteEducationScreen> createState() =>
      InorganicWasteEducationScreenState();
}

class InorganicWasteEducationScreenState
    extends State<InorganicWasteEducationScreen> {
            ...
            Padding(
              ...
              child: Container(
                ...
                child: ClipRRect(
                  borderRadius: BorderRadius.circular(24),
                  child: Image.asset(
                    'assets/images/inorganic_education/introduction.png',
                    height: 220,
                    fit: BoxFit.cover,
                  ),
                ),
                ...
                ? GestureDetector(
                    ...
                    child: Padding(
                      ...
                      child: ClipRRect(
                        ...
                        child: Image.asset(
                          'assets/images/inorganic_education/inorganic_info/images/$_selectedImage.png',
                          fit: BoxFit.contain,
                          width: double.infinity,
                        ),
                      ),
                              ...
                              .map(
                                (name) => GestureDetector(
                                  ...
                                  child: SvgPicture.asset(
                                    'assets/images/inorganic_education/inorganic_info/button/$name.svg',
                                  ),
                                ),
                              )
                              .toList(),
...
class _AnimatedWasteCarouselState extends State<_AnimatedWasteCarousel> {
  ...
  final List<String> _items = [
    'assets/images/inorganic_education/examples/plastic_bottle.png',
    'assets/images/inorganic_education/examples/glass_jars.png',
    'assets/images/inorganic_education/examples/metal_cans.png',
    'assets/images/inorganic_education/examples/electronic_waste.png',
    'assets/images/inorganic_education/examples/batteries.png',
    'assets/images/inorganic_education/examples/synthetic_rubber.png',
  ];
...
class _MythFactCardStackState extends State<MythFactCardStack> {
  ...
  @override
  Widget build(BuildContext context) {
    const String basePath = 'assets/images/inorganic_education/myth_fact';
