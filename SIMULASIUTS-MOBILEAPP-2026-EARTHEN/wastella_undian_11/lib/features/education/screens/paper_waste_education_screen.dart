...
class PaperWasteEducationScreen extends StatelessWidget {
  const PaperWasteEducationScreen({super.key});
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: const DecorationImage(
                    image: AssetImage('assets/images/paper-waste.png'),
                    fit: BoxFit.cover,
                  ),
                ),
                child: Container(
                  ...
                  child: const Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 12),
                      Text(
                        'Paper waste refers to discarded or unused paper materials, including misprinted, excess, or unnecessary paper, that contribute to environmental pollution and resource depletion',
                        textAlign: TextAlign.center,
                        style: TextStyle(
                          color: Colors.white,
                          fontSize: 13,
            ...
            const SizedBox(height: 370, child: _PaperWasteCarousel()),
            ...
            const Padding(
              ...
              child: Text(
                'Environmental Impacts of Paper Waste',
                textAlign: TextAlign.center,
                style: TextStyle(
                  color: Colors.black,
                  fontSize: 20,
            ...
            Padding(
              ...
              child: Wrap(
                ...
                children: const [
                  _ImpactItem(title: 'Deforestation', icon: Icons.forest),
                  _ImpactItem(title: 'Water Waste', icon: Icons.water_drop),
                  _ImpactItem(title: 'Carbon\nEmission', icon: Icons.co2),
                  _ImpactItem(
                    title: 'Landfill\nOverflow',
                  ...
                  _ImpactItem(title: 'Habitat Loss', icon: Icons.nature),
                ],
              ),
            ),
            ...
            const Padding(
              padding: EdgeInsets.symmetric(horizontal: 40),
              child: Text(
                'Myth and Facts About Paper Waste',
                textAlign: TextAlign.center,
                style: TextStyle(
                  color: Colors.black,
                  fontSize: 20,
              ...
              child: Row(
                children: const [
                  _MythFactCard(
                    ...
                    content: "Paper waste isn't a big issue",
                  ...
                  _MythFactCard(
                    ...
                    content:
                        'Paper accounts for a large portion of landfill waste and contributes significantly to deforestation',
            ...
            const Padding(
              padding: EdgeInsets.symmetric(horizontal: 40),
              child: Text(
                'Why Managing Paper Waste Matters',
                textAlign: TextAlign.center,
                style: TextStyle(
                  color: Colors.black,
                  fontSize: 20,
...
// ─────────────────────────────────────────────────────────────────
// Stacked "Why Matter" cards — tappable deck that cycles through cards
// ─────────────────────────────────────────────────────────────────
...
class _StackedWhyMatterCardsState extends State<_StackedWhyMatterCards>
  ...
  final List<Map<String, String>> _cards = const [
    ...
    },
    {
      'title': 'Save Trees',
      'description':
          'Reducing paper waste helps conserve forests, protecting wildlife habitats and maintaining biodiversity, which is essential for a balanced ecosystem',
    },
  ];
...
// ─────────────────────────────────────────────────────────────────
// Auto-scrolling carousel for paper waste examples
// ─────────────────────────────────────────────────────────────────
class _PaperWasteCarousel extends StatefulWidget {
  const _PaperWasteCarousel();

  @override
  State<_PaperWasteCarousel> createState() => _PaperWasteCarouselState();
}

class _PaperWasteCarouselState extends State<_PaperWasteCarousel> {
  late final PageController _pageController;
  int _currentPage = 1000;
  Timer? _timer;

  final List<Map<String, String>> _items = [
    {'label': 'Old Newspaper', 'image': 'assets/images/paper-waste.png'},
    {
      'label': 'Disposable Paper',
      'image': 'assets/images/noisy-gradients-1.png',
    },
    {
      'label': 'Single-use Cups\nand plates',
      'image': 'assets/images/noisy-gradients-2.png',
    },
  ];
...
// ─────────────────────────────────────────────────────────────────
// Why Matter card (used in the stacked deck)
// ─────────────────────────────────────────────────────────────────
        ...
        decoration: BoxDecoration(
          ...
          gradient: LinearGradient(
            ...
            colors: [
              ...
              const Color(0xFF04291F).withValues(alpha: 0.95),
            ],
          ),
        ),
        padding: const EdgeInsets.all(24),
